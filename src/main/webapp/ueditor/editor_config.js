...
(function () {
   ...
   // URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    URL="http://localhost:8180/ueditor/";
    /**
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["fullscreen","source","undo","redo","unlink","link","attachment","insertimage","emotion","gmap","map","bold","italic","underline","strikethrough","forecolor","fontsize","pasteplain","fontfamily","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","inserttable","searchreplace","formatmatch","cleardoc","preview"]]
